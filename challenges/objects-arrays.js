...
zooAnimals.map(function(animalNamesLow){
  lowCaseAnimalNames.push(animalNamesLow.animal_name.toLowerCase())
})
...
*/
const populationTotal = zooAnimals.reduce(function(accumulator, total){
